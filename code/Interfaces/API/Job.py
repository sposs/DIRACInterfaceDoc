'''
This job class should not be used to create jobs. It shouldn't need changes either.
...
class Job(DiracJob):
    ...
    def __init__(self, script = None):
        ...
        self.log = gLogger.getSubLogger("BaseJob")
    ...
    def _askUser(self):
        ...
        Called from Dirac class to prompt the user
        """
        if not self.check:
            return S_OK()
...
#          
    ...
    ######## Internal methods. Shouldn't be overloaded.
