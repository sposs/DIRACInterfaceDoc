...
class ApplicationScript(ModuleBase):
    ...
    def __init__(self):
        ...
        self.script = None # Overwritten by the Workflow class when initializing the module
        self.arguments = '' # Overwritten by the Workflow class when initializing the module
